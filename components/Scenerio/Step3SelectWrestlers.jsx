...
const Step3SelectWrestlers = ({ selectedWrestlers, setSelectedWrestlers, nextStep, prevStep, auth }) => {
  ...
  useEffect(() => {
    ...
    fetchWrestlers();
  }, [pageNumber, auth.user.Brand]);

  return (
    <div>
      <h1 className="text-3xl font-bold mb-6 text-center">Step 3: Select Wrestlers</h1>
...
export default Step3SelectWrestlers;
