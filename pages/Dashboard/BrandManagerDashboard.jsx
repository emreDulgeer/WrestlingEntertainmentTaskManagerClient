...
const BrandManagerDashboard = () => {
  ...
  const { auth } = useAuth(); // Auth context'i alıyoruz.

  useEffect(() => {
    const fetchShows = async () => {
      try {
        // Token'dan kullanıcıya ait Brand bilgisini al
        ...
        // Backend'e brand filtresiyle istek yap
  ...
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-4">Brand Manager Dashboard</h1>
